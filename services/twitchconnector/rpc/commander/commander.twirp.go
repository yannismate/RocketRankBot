...
// NewCommanderProtobufClient creates a Protobuf client that implements the Commander interface.
// It communicates using Protobuf and can be configured with a custom HTTPClient.
func NewCommanderProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Commander {
...
func (c *commanderProtobufClient) ExecutePossibleCommand(ctx context.Context, in *ExecutePossibleCommandReq) (*ExecutePossibleCommandRes, error) {
	...
	ctx = ctxsetters.WithMethodName(ctx, "ExecutePossibleCommand")
	caller := c.callExecutePossibleCommand
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *ExecutePossibleCommandReq) (*ExecutePossibleCommandRes, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*ExecutePossibleCommandReq)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*ExecutePossibleCommandReq) when calling interceptor")
					}
					return c.callExecutePossibleCommand(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*ExecutePossibleCommandRes)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*ExecutePossibleCommandRes) when calling interceptor")
				}
...
func (c *commanderProtobufClient) callExecutePossibleCommand(ctx context.Context, in *ExecutePossibleCommandReq) (*ExecutePossibleCommandRes, error) {
...
// NewCommanderJSONClient creates a JSON client that implements the Commander interface.
// It communicates using JSON and can be configured with a custom HTTPClient.
func NewCommanderJSONClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Commander {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
...
func (c *commanderJSONClient) ExecutePossibleCommand(ctx context.Context, in *ExecutePossibleCommandReq) (*ExecutePossibleCommandRes, error) {
	ctx = ctxsetters.WithPackageName(ctx, "github.com.yannismate.rocketrankbot.commander")
	ctx = ctxsetters.WithServiceName(ctx, "Commander")
	ctx = ctxsetters.WithMethodName(ctx, "ExecutePossibleCommand")
	caller := c.callExecutePossibleCommand
...
// NewCommanderServer builds a TwirpServer that can be used as an http.Handler to handle
// HTTP requests that are routed to the right method in the provided svc implementation.
// The opts are twirp.ServerOption modifiers, for example twirp.WithServerHooks(hooks).
func NewCommanderServer(svc Commander, opts ...interface{}) TwirpServer {
...
func (s *commanderServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// handleRequestBodyError is used to handle error when the twirp server cannot read request
func (s *commanderServer) handleRequestBodyError(ctx context.Context, resp http.ResponseWriter, msg string, err error) {
...
// CommanderPathPrefix is a convenience constant that may identify URL paths.
// Should be used with caution, it only matches routes generated by Twirp Go clients,
// with the default "/twirp" prefix and default CamelCase service and method names.
// More info: https://twitchtv.github.io/twirp/docs/routing.html
const CommanderPathPrefix = "/twirp/github.com.yannismate.rocketrankbot.commander.Commander/"

func (s *commanderServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "github.com.yannismate.rocketrankbot.commander")
	ctx = ctxsetters.WithServiceName(ctx, "Commander")
	...
	if pkgService != "github.com.yannismate.rocketrankbot.commander.Commander" {
...
func (s *commanderServer) serveExecutePossibleCommand(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	case "application/json":
		s.serveExecutePossibleCommandJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveExecutePossibleCommandProtobuf(ctx, resp, req)
	default:
...
func (s *commanderServer) serveExecutePossibleCommandJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "ExecutePossibleCommand")
	...
	reqContent := new(ExecutePossibleCommandReq)
	...
	handler := s.Commander.ExecutePossibleCommand
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *ExecutePossibleCommandReq) (*ExecutePossibleCommandRes, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.Commander.ExecutePossibleCommand(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*ExecutePossibleCommandRes)
	...
	// Call service method
	var respContent *ExecutePossibleCommandRes
	func() {
...
func (s *commanderServer) serveExecutePossibleCommandProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "ExecutePossibleCommand")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *commanderServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *commanderServer) ProtocGenTwirpVersion() string {
	return "v8.1.3"
}
...
func (s *commanderServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "github.com.yannismate.rocketrankbot.commander", "Commander")
}
